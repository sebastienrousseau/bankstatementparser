...
<Document>
    <BkToCstmrStmt>
        ...
        try:
            ...
            self.assertEqual(transactions.iloc[1]['Amount'], -100.00)  # DBIT is negative
...
<Document>
    <BkToCstmrStmt>
        ...
        try:
            ...
            self.assertEqual(transactions.iloc[0]['Amount'], 999999999999.99)
            self.assertAlmostEqual(transactions.iloc[1]['Amount'], 0.000001, places=6)
        finally:
            os.unlink(test_file)
...
<Document>
    <BkToCstmrStmt>
        ...
        try:
            ...
            self.assertEqual(transactions.iloc[0]['Debtor'], 'John "Doe" & Co.')
...
<Document>
    <BkToCstmrStmt>
        ...
        try:
            ...
            self.assertEqual(transactions.iloc[1]['ValDt'], '2023-01-02T14:30:00')
        finally:
            os.unlink(test_file)
