...
| **Tested** | 963 tests, coverage gated at 100% in CI, property-based fuzzing with Hypothesis |
...
tests/                          963 tests (unit, integration, property-based, security, hybrid mocks)
```
