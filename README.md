...
| **Tested** | 998 tests, coverage gated at 100% in CI, property-based fuzzing with Hypothesis |
...
tests/                          998 tests (unit, integration, property-based, security, hybrid mocks)
```
