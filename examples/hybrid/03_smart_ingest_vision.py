...
def main() -> int:
    ...
    print(
        f"  decision:                   {'route to vision' if char_count < LOW_TEXT_DENSITY_THRESHOLD else 'stay on text-LLM'}"
    )
    print()
    ...
    if live:
        ...
        print(
            "Set BSP_HYBRID_VISION_MODEL=ollama/llava (and run `ollama serve`)"
        )
